			...
			<div id="webname"><img src="../public/img/nhanvienlogin/WebName.png" alt="WebName">
                <div id="header_icon">
                     <div id="home" ><a href="../logout.php"><img src="../public/img/nhanvienlogin/thoat.png" style="margin-top: 20px" alt="Thoát"></a></div>
                        <div id="logout" style="margin:0px; padding:0; "><a href="GianVienLogin.php"><img src="../public/img/nhanvienlogin/trangchu.png" style="margin: 0px;" alt="Trang chủ"></a></div>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="padding: 5px">
                        <td style="padding-top: 5px">
                            ...
                            $thang=date('m');
                            $nam=date('Y');
                            echo '<div class="itemFuntion"><a href="GVLuong.php?thang='.$thang.'&nam='.$nam.'"><img src="../public/img/nhanvienlogin/bangluongicon.jpg" height="67px" width="67px" alt=""></a></div>';
                            ?>
