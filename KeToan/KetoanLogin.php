                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="padding: 5px">
                        <td style="padding-top: 5px">
                            ...
                            $thang=date('m');
                            $nam=date('Y');
                            echo '<div class="itemFuntion"><a href="KTQuanliLuong.php?thang='.$thang.'&nam='.$nam.'"><img src="../public/img/nhanvienlogin/earnings-512.png" height="67px" width="67px" alt=""></a></div>';
                                ?>
                        </td>
                        <td style="padding-top: 5px">
                            <?php
                            echo '<div class="itemFuntion"><a href="Guiemail.php?thang='.$thang.'&nam='.$nam.'"><img src="../public/img/nhanvienlogin/email-icon-23.png" height="67px" width="67px" alt=""></a></div>';
                        ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px">
                            <div class="itemFuntion"><b>Quản lý lương</b></div>
                        </td>
                        <td style="padding-top: 5px">
                            <div class="itemFuntion"><b>Gửi email</b></div>
                        </td>
                    </tr>
                    <tr style="padding: 5px">
                        <td style="padding-top: 5px">
